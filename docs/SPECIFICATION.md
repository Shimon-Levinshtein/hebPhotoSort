# 📸 HebPhotoSort - מערכת מיון תמונות

## סקירה כללית
אפליקציית ווב (React + Node) למיון תמונות אוטומטי/ידני. המשתמש מזין תיקיית מקור ותיקיית יעד, והשרת מסייע במיון התמונות.

### 🌟 פיצ'ר מרכזי: מיון לפי תאריך עברי
- המערכת קוראת את **תאריך יצירת התמונה** מנתוני EXIF
...
### Phase 1 - MVP (גרסה ראשונה)
- [x] בחירת תיקיית מקור (הזנת נתיב)
- [x] בחירת תיקיית יעד (הזנת נתיב)
- [x] הצגת תמונות מתיקיית המקור בגריד
- [x] תצוגה מקדימה של תמונה בודדת
- [x] **קריאת תאריך יצירת התמונה מ-EXIF**
- [x] **המרת תאריך לועזי לתאריך עברי**
- [x] **יצירת תיקיות לפי תאריך עברי (חודש/שנה)**
- [x] העברת/העתקת תמונה לתיקיית היעד
- [x] מעבר בין תמונות (הבא/הקודם)
- [x] מונה התקדמות
